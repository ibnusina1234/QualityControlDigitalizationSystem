...
// Animation component for counters
...
// Floating animation component (ANIMASI DIHILANGKAN)
      ...
      <div className="w-full overflow-x-auto">
        <div className="min-w-[900px]">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {/* Total Samples Card */}
            <FloatingCard>
              <div className={`${getTotalCardClass()} rounded-xl shadow-xl p-4 transition-all duration-500 hover:scale-105 transform`}>
            ...
            <FloatingCard>
              <div className={`${getReleasedCardClass()} rounded-xl shadow-xl p-4 transition-all duration-500 hover:scale-105 transform`}>
                <div className="flex justify-between items-start">
                  <div>
            ...
            <FloatingCard>
              <div className={`${getRejectedCardClass()} rounded-xl shadow-xl p-4 transition-all duration-500 hover:scale-105 transform`}>
                <div className="flex justify-between items-start">
                  <div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
              <FloatingCard>
                <div className={`${getTotalCardClass()} rounded-xl shadow-lg p-4`}>
                  <div className="flex justify-between items-start">
                    <div>
